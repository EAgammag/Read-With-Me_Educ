    ...
    <div class="py-6">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form action="{{ route('admin.sentences.store') }}" method="POST" class="p-6 space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <textarea name="sentence" id="sentence" rows="3" required
                                  ...
                                  placeholder="e.g., The quick brown fox jumps over the lazy dog.">{{ old('sentence') }}</textarea>
                        @error('sentence')
